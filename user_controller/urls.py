from user_controller.views import FacebookConnect, GoogleConnect, CustomUserView, FacebookLogin, GoogleLogin, UpdateProfileView, index
...
urlpatterns = [
    ...
    path('initiate-google-login/', index, name='google'),
]
